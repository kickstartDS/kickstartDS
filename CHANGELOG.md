...
- `@kickstartds/base@4.0.0`, `@kickstartds/core@4.0.0`
...
- fix(docs): add some more scaffolding [#1092](https://github.com/kickstartDS/kickstartDS/pull/1092) ([@julrich](https://github.com/julrich))
...
- build(deps-dev): bump commitizen from 4.2.4 to 4.2.5 [#1135](https://github.com/kickstartDS/kickstartDS/pull/1135) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps-dev): bump chromatic from 6.5.4 to 6.5.6 [#1049](https://github.com/kickstartDS/kickstartDS/pull/1049) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps-dev): bump auto from 10.34.1 to 10.36.5 [#938](https://github.com/kickstartDS/kickstartDS/pull/938) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps): bump yargs-parser from 21.0.0 to 21.0.1 [#880](https://github.com/kickstartDS/kickstartDS/pull/880) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump postcss from 8.4.6 to 8.4.7 [#877](https://github.com/kickstartDS/kickstartDS/pull/877) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump stylelint from 14.5.2 to 14.5.3 [#876](https://github.com/kickstartDS/kickstartDS/pull/876) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps-dev): bump chromatic from 6.4.3 to 6.5.1 [#866](https://github.com/kickstartDS/kickstartDS/pull/866) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps): bump rollup from 2.67.2 to 2.67.3 [#864](https://github.com/kickstartDS/kickstartDS/pull/864) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps): bump @iwsio/json-csv-node from 5.0.3 to 5.0.4 [#854](https://github.com/kickstartDS/kickstartDS/pull/854) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump @babel/core from 7.17.2 to 7.17.4 [#852](https://github.com/kickstartDS/kickstartDS/pull/852) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump json-csv from 4.0.3 to 4.0.5 [#853](https://github.com/kickstartDS/kickstartDS/pull/853) ([@dependabot[bot]](https://github.com/dependabot[bot]) [@lmestel](https://github.com/lmestel))
- build(deps-dev): bump @storybook/core from 6.4.18 to 6.4.19 [#844](https://github.com/kickstartDS/kickstartDS/pull/844) ([@dependabot[bot]](https://github.com/dependabot[bot]) [@lmestel](https://github.com/lmestel))
- build(deps): bump @rollup/plugin-replace from 3.0.1 to 3.1.0 [#841](https://github.com/kickstartDS/kickstartDS/pull/841) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump lint-staged from 12.3.3 to 12.3.4 [#843](https://github.com/kickstartDS/kickstartDS/pull/843) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps): bump rollup from 2.67.1 to 2.67.2 [#833](https://github.com/kickstartDS/kickstartDS/pull/833) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps): bump rollup-plugin-node-externals from 3.1.2 to 4.0.0 [#815](https://github.com/kickstartDS/kickstartDS/pull/815) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump stylelint from 14.3.0 to 14.4.0 [#820](https://github.com/kickstartDS/kickstartDS/pull/820) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump cssnano from 5.0.16 to 5.0.17 [#818](https://github.com/kickstartDS/kickstartDS/pull/818) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump rollup from 2.67.0 to 2.67.1 [#817](https://github.com/kickstartDS/kickstartDS/pull/817) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps-dev): bump auto from 10.32.5 to 10.32.6 [#803](https://github.com/kickstartDS/kickstartDS/pull/803) ([@dependabot[bot]](https://github.com/dependabot[bot]) [@lmestel](https://github.com/lmestel))
...
- build(deps): bump postcss from 8.4.5 to 8.4.6 [#806](https://github.com/kickstartDS/kickstartDS/pull/806) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump rollup from 2.65.0 to 2.67.0 [#807](https://github.com/kickstartDS/kickstartDS/pull/807) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump typescript from 4.5.3 to 4.5.5 [#804](https://github.com/kickstartDS/kickstartDS/pull/804) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump @storybook/cli from 6.4.13 to 6.4.18 [#801](https://github.com/kickstartDS/kickstartDS/pull/801) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump cssnano from 5.0.15 to 5.0.16 [#784](https://github.com/kickstartDS/kickstartDS/pull/784) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump lint-staged from 12.2.2 to 12.3.2 [#787](https://github.com/kickstartDS/kickstartDS/pull/787) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump @babel/core from 7.16.7 to 7.16.12 [#780](https://github.com/kickstartDS/kickstartDS/pull/780) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump @commitlint/cli from 16.0.2 to 16.1.0 [#773](https://github.com/kickstartDS/kickstartDS/pull/773) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump nanoid from 3.1.30 to 3.2.0 [#779](https://github.com/kickstartDS/kickstartDS/pull/779) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump chromatic from 6.4.0 to 6.4.1 [#778](https://github.com/kickstartDS/kickstartDS/pull/778) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump rollup from 2.64.0 to 2.65.0 [#777](https://github.com/kickstartDS/kickstartDS/pull/777) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump lint-staged from 12.1.7 to 12.2.2 [#774](https://github.com/kickstartDS/kickstartDS/pull/774) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump trim-off-newlines from 1.0.1 to 1.0.3 [#770](https://github.com/kickstartDS/kickstartDS/pull/770) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps): bump chokidar from 3.5.2 to 3.5.3 [#764](https://github.com/kickstartDS/kickstartDS/pull/764) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps): bump shelljs from 0.8.4 to 0.8.5 [#750](https://github.com/kickstartDS/kickstartDS/pull/750) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump nth-check from 2.0.0 to 2.0.1 [#749](https://github.com/kickstartDS/kickstartDS/pull/749) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps): bump rollup-plugin-styles from 3.14.1 to 4.0.0 [#748](https://github.com/kickstartDS/kickstartDS/pull/748) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump @storybook/core from 6.4.10 to 6.4.12 [#742](https://github.com/kickstartDS/kickstartDS/pull/742) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump @commitlint/cli from 16.0.1 to 16.0.2 [#735](https://github.com/kickstartDS/kickstartDS/pull/735) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps): bump autoprefixer from 10.4.1 to 10.4.2 [#736](https://github.com/kickstartDS/kickstartDS/pull/736) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
- build(deps): bump cssnano from 5.0.14 to 5.0.15 [#725](https://github.com/kickstartDS/kickstartDS/pull/725) ([@dependabot[bot]](https://github.com/dependabot[bot]))
- build(deps-dev): bump @storybook/core from 6.4.9 to 6.4.10 [#727](https://github.com/kickstartDS/kickstartDS/pull/727) ([@dependabot[bot]](https://github.com/dependabot[bot]) [@lmestel](https://github.com/lmestel))
- build(deps-dev): bump lint-staged from 12.1.5 to 12.1.7 [#726](https://github.com/kickstartDS/kickstartDS/pull/726) ([@dependabot[bot]](https://github.com/dependabot[bot]))

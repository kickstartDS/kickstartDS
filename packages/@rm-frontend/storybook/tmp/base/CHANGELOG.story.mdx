...
&lt;a name=&quot;@rm-frontend/base-v11.0.0&quot;&gt;&lt;/a&gt;
...
* **schema:** fix schema id for textpic intext left ([2d98826](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/2d98826))
...
* **footer:** add variables, ([7763c9b](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/7763c9b))
...
&lt;a name=&quot;@rm-frontend/base-v9.25.1&quot;&gt;&lt;/a&gt;
...
&lt;a name=&quot;@rm-frontend/base-v9.23.1&quot;&gt;&lt;/a&gt;
...
&lt;a name=&quot;@rm-frontend/base-v9.21.2&quot;&gt;&lt;/a&gt;
...
* **tag-label:** add tag-label hover transition ([cc422db](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/cc422db))
...
&lt;a name=&quot;@rm-frontend/base-v9.15.0&quot;&gt;&lt;/a&gt;
...
&lt;a name=&quot;@rm-frontend/base-v9.13.4&quot;&gt;&lt;/a&gt;
...
* **rich-text:** fix rich text demo template ([b9acd2c](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/b9acd2c))
...
&lt;a name=&quot;@rm-frontend/base-v9.6.0&quot;&gt;&lt;/a&gt;
...
* **visuals:** wrap key- &amp; introvisuals with div container `.page-intro` ([8f83291](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/8f83291))
...
&lt;a name=&quot;@rm-frontend/base-v9.1.3&quot;&gt;&lt;/a&gt;
...
* add some missing attributes on input atom ([a60f67d](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/a60f67d))
...
* **base:** don&#39;t print cookie consent if it&#39;s disabled in .rm-frontendrc ([455b25e](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/455b25e))
...
* **base:** use correct variables for button styles ([6a107a1](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/6a107a1))
...
&lt;a name=&quot;@rm-frontend/base-v8.2.0&quot;&gt;&lt;/a&gt;
...
&lt;a name=&quot;@rm-frontend/base-v5.5.0&quot;&gt;&lt;/a&gt;
...
&lt;a name=&quot;@rm-frontend/base-v5.0.0&quot;&gt;&lt;/a&gt;
...
&lt;a name=&quot;@rm-frontend/base-v2.0.0&quot;&gt;&lt;/a&gt;
...
&lt;a name=&quot;@rm-frontend/base-v1.11.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.11.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.10.2@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.11.0@next) (2019-11-19)
...
&lt;a name=&quot;@rm-frontend/base-v1.10.2&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.10.2](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.10.1@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.10.2@latest) (2019-11-15)


### Bug Fixes

* **base:** bring back table-variants by providing data.json ([5687cc8](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/5687cc8))

&lt;a name=&quot;@rm-frontend/base-v1.10.1&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.10.1](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.10.0@next&amp;sourceBranch=refs%2Ftags%2Fbase@1.10.1@latest) (2019-11-15)
...
&lt;a name=&quot;@rm-frontend/base-v1.10.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.10.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.9.0@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.10.0@next) (2019-11-15)


### Features

* **base:** don&#39;t close other collapsible boxes ([3bebdb8](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/3bebdb8))

&lt;a name=&quot;@rm-frontend/base-v1.9.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.9.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.8.0@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.9.0@next) (2019-11-08)


### Bug Fixes

* **base:** fix header transition ([f8c3066](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/f8c3066))
...
* **base:** add clear button and button animation variations, ([16816dc](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/16816dc))
* **base:** add lightbox-images to content-box ([e2c83c5](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/e2c83c5))
...
* **base:** rename classes and change divs into spans ([ae4456d](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/ae4456d))
* **base:** unify image components ([e6aaf78](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/e6aaf78))
...
&lt;a name=&quot;@rm-frontend/base-v1.8.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.8.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.7.2@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.8.0@next) (2019-10-30)
...
&lt;a name=&quot;@rm-frontend/base-v1.7.2&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.7.2](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.7.1@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.7.2@latest) (2019-10-30)


### Bug Fixes

* **base:** move breakpoint definition into critical css ([7137786](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/7137786))

&lt;a name=&quot;@rm-frontend/base-v1.7.1&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.7.1](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.7.0@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.7.1@latest) (2019-10-25)


### Bug Fixes

* **base:** remove checkbox group validation msg only if it exists ([448e2bf](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/448e2bf))
* **base:** remove href from spans in content-nav ([20f9c5c](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/20f9c5c))

&lt;a name=&quot;@rm-frontend/base-v1.7.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.7.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.6.0@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.7.0@next) (2019-10-25)


### Features

* **base:** make nav-content-menu interactive ([a69a634](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/a69a634))

&lt;a name=&quot;@rm-frontend/base-v1.6.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.6.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.5.0@next&amp;sourceBranch=refs%2Ftags%2Fbase@1.6.0@next) (2019-10-24)
...
&lt;a name=&quot;@rm-frontend/base-v1.5.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.5.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.4.0@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.5.0@next) (2019-10-24)
...
&lt;a name=&quot;@rm-frontend/base-v1.4.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.4.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.3.0@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.4.0@next) (2019-10-22)
...
&lt;a name=&quot;@rm-frontend/base-v1.3.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.3.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.2.0@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.3.0@next) (2019-10-15)


### Features

* **base:** add embedded-map variation ([1720283](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/1720283))
* **base:** optimize embedded map and add variations to startpage ([b3ccf70](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/b3ccf70))
...
&lt;a name=&quot;@rm-frontend/base-v1.2.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.2.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.1.0@next&amp;sourceBranch=refs%2Ftags%2Fbase@1.2.0@next) (2019-10-10)
...
* **base:** fix contact flag label query ([ecb663c](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/ecb663c))
* **base:** remove max-width from template ([c1721fc](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/c1721fc))
...
* **base:** add textpic organism &amp; l-section modifier for narrow width ([ff47bdf](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/ff47bdf))

&lt;a name=&quot;@rm-frontend/base-v1.1.0&quot;&gt;&lt;/a&gt;
# [@rm-frontend/base-v1.1.0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/compare/diff?targetBranch=refs%2Ftags%2Fbase@1.0.0@latest&amp;sourceBranch=refs%2Ftags%2Fbase@1.1.0@next) (2019-10-02)


### Bug Fixes

* **base:** add caption style to textpic ([b87b9cd](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/b87b9cd))
* **base:** fix nav-toggle styling ([d4c0136](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/d4c0136))
...
&lt;a name=&quot;@rm-frontend/base-v1.0.0&quot;&gt;&lt;/a&gt;
# @rm-frontend/base-v1.0.0 (2019-09-26)


### Bug Fixes

* **base:** bring back contact flag label ([dfa0258](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/dfa0258))
* **base:** fix broken PubSub import ([cee6581](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/cee6581))
* **base:** fix content navigation equal height ([e41844c](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/e41844c))
* **base:** fix content slider arrow calculation ([9d45f6c](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/9d45f6c))
* **base:** fix dropdowns in safari ([33fed1f](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/33fed1f))
* **base:** fix element height calculation in slide functions ([649f092](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/649f092))
* **base:** fix header scrolling ([6b645b1](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/6b645b1))
* **base:** fix header style ([42bb017](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/42bb017))
* **base:** fix language attribute parsing ([9105d44](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/9105d44))
* **base:** fix main nav chevron position in safari ([4b31072](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/4b31072))
* **base:** fix main nav size and icon transition ([4394e3e](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/4394e3e))
* **base:** fix man nav sub level positioning ([1c3674b](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/1c3674b))
* **base:** fix nav lang critical style ([56684c3](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/56684c3))
* **base:** fix page overflow &amp; scroll-to-top-btn behavior ([107016b](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/107016b))
* **base:** fix sidebar spacing ([81c842a](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/81c842a))
* **base:** fix slider keyboard nav ([d1008f4](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/d1008f4))
* **base:** fix some grid stuff ([e2850e7](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/e2850e7))
* **base:** fix sticky scroll ([b232568](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/b232568))
* **base:** fix uuid generation ([f214cea](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/f214cea))
* **base:** force layout repaint in slider to trigger image size recalculation in firefox ([edafec4](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/edafec4))
* **base:** FRONT-8 send form only if its valid ([50f4d89](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/50f4d89))
* **base:** make grid mixins ie safe ([9ae43b2](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/9ae43b2))
* **base:** prevent slider from jumping into view when set to autoplay ([0aed2b0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/0aed2b0))
* **base:** test a bug / patch release ([e211eeb](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/e211eeb))
* **base:** this tests a breaking bugfix ([466271b](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/466271b))
...
* **base:** remove unwanted whitespaces ([35465db](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/35465db))


### Features

* **base:** add `prepend` polyfill for ie ([5bd77ff](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/5bd77ff))
* **base:** add $gallery-hover-scale in var-instance ([68aa2b7](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/68aa2b7))
* **base:** add config for main nav open on hover ([ede8fe4](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/ede8fe4))
* **base:** add custom validator for checkbox groups ([441d02a](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/441d02a))
* **base:** add new icon (zoom) ([608bf40](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/608bf40))
* **base:** BWTY-259 add microdata ([86af5ec](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/86af5ec))
* **base:** BWTY-698 adjust textpic spacing in left &amp; right sidebar ([1b7cc34](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/1b7cc34))
* **base:** focus body on &#39;scroll-to-top&#39; ([f38225e](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/f38225e))
* **base:** FRONT-15 use custom web font ([58db378](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/58db378))
* **base:** FRONT-16 dedupe css output ([a98c05a](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/a98c05a))
* **base:** FRONT-21 allow not-links in content navigation list ([7d624c3](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/7d624c3))
...
* **base:** FRONT-7 ignore unneeded components ([0f2ec49](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/0f2ec49))
* **base:** include cookieconsent into bundle ([8b5280f](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/8b5280f))
* **base:** load form js lazy, update stickybits dependency ([9798f7d](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/9798f7d))
* **base:** make form validation messages configurable ([4939d4c](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/4939d4c))
...
* **base:** make sliders keyboard accessible ([5da0a4f](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/5da0a4f))
* **base:** show extranet buttons (login, logout, profil) only when nedded ([abb4a3f](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/abb4a3f))
* **base:** test a feature / minor release ([b730235](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/b730235))
* **base:** testing another feature release ([c5e9d8e](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/c5e9d8e))
* **base:** update simplebar dependency ([ea45ad4](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/ea45ad4))
...
* **base:** avoid layout jumping on overlay toggle ([693d0d7](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/693d0d7))
* **base:** improve scrolling performance ([801eb87](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/801eb87))
* don&#39;t render unused icons ([0f77ad6](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/0f77ad6))
* **base:** connect lightbox to new slider ([7e97d3d](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/7e97d3d))
* **base:** move animate css out of base tools ([bd24b9b](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/bd24b9b))
...
* add base component ([af83dfe](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/af83dfe))
...
* **base:** add autoplay option to slider ([bad75a0](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/bad75a0))
* **base:** add debounce helper ([f89f174](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/f89f174))
* **base:** add filter-area component ([c0cd964](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/c0cd964))
* **base:** add focus-visible polyfill ([14dd199](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/14dd199))
* **base:** add slide &amp; fade helper ([49f031d](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/49f031d))
* **base:** bring back footer background color ([d987138](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/d987138))
* **base:** bring back footer background color ([c02651f](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/c02651f))
* **base:** create own nav-toggle component ([6984c37](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/6984c37))
* **base:** keyvisual mobile first ([96c4fef](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/96c4fef))
* **base:** minor nav improvements ([f68de67](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/f68de67))
* **base:** replace jquery-sticky with stickybits ([e0cf3ef](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/e0cf3ef))
* **base:** rewrite nav-lang as es6 class ([6e5dc1c](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/6e5dc1c))
...
* **base:** revert browser-sniffing script ([19a4e59](https://bitbucket.ruhmesmeile.tools/projects/front/repos/rm-frontend/commits/19a4e59))


### BREAKING CHANGES

* **base:** this breaks!
* **search:** markup changed
* **base:** markup changes in keyvisual

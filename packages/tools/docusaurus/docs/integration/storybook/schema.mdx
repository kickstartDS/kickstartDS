...
To integrate your [component API](../../foundations/components/component-api.md) / **JSON Schema** into **Storybook** you can install an addon we've written specifically for that purpose:
...
View the addon on **Github**: https://github.com/kickstartDS/storybook-addon-jsonschema<br />
Or directly on **Storybook**s page: https://storybook.js.org/addons/@kickstartds/storybook-addon-jsonschema

<img
  src={require('./assets/teaser-jsonschema.png').default}
  alt="Image showing the JSON Schema addon in action"
/>
...
For a detailed explanation on how to add this to your project, have a look [at part three of our "Create your Design System"](../../guides/create/storybook.mdx#install-remaining-addons) guide.

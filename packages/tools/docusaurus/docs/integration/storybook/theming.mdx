...
To learn how to use this in your own **Storybook**, have a look at [part three of our "Create your Design System"](../../guides/create/storybook.mdx) guide for an in-depth explanation.

...
TODO should / could possibly include "Component documentation" as a fourth step, where the **Storybook** story is added
...
TODO add content module CTA here
...
TODO describe invert feature somewhere, link it above
...
TODO check `TeaserBoxProvider` usage here, probably not useful? If useful... describe why here! also fix text above which still is copy &amp; pasted directly from "Adapt a component"

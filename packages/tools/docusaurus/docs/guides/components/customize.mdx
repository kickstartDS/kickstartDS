...
Finding your component definition is still very simplified, we just have to add those properties, not covered by the base component, ourselves.
...
TODO fix formatting in first code sample here

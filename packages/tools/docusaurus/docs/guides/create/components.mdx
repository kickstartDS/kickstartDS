...
This also serves as an example for [**adapting** a component](../components/adapt.mdx), where we mostly take a component directly from **kickstartDS**, while still finding our own, often more restrictire, [component API](../../foundations/components/component-api.md) for it.

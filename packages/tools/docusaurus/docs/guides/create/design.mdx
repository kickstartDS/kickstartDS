...
For a more in-depth overview of this process, have a look at our [Generate Token Set guide](../theming/generate-token-set.md) or the [foundations page about **Branding Token**](../../foundations/token/branding-token.mdx), detailing all values in use.<br/>

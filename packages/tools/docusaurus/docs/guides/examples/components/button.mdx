...
This guided example shows how you'd typically add components to your Design System that are directly based on components part of **kickstartDS**. This mostly includes components that are needed in every Design System, and that typically also get added with the same name (like our `Button` here).
...
It will only need two simple steps:
